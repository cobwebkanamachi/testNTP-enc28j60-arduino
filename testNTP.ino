//https://github.com/Microduino/Microduino_Tutorials/blob/master/Microduino_ENC/ENCnetworktwelve/ENCnetworktwelve.ino
#include <EtherCard.h>
...
static byte ntpServer[] = {172,0,0,1}; //you should change this with your NTP SRV in decimal comma separated, for example : 172,0,0,1
static byte srcPort = 0;



uint32_t timeStamp;
//unsigned long timeStamp; //kludge www
boolean requestSent;
